...
!  print*,rank,'ww Sets concentrations of inactive species'
  conc_tl(nspec+1,1:nzonal,1:nmerid,1:nverti) = 0.d0
  conc_tl(nspec+2,1:nzonal,1:nmerid,1:nverti) = 0.d0 
  conc_tl(nspec+3,1:nzonal,1:nmerid,1:nverti) = 0.d0 
  conc_tl(nspec+4,1:nzonal,1:nmerid,1:nverti) = 0.d0
