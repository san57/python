...
#define NCERR(lnum) if(ncstat/=NF90_NOERR) call nc_err(ncstat,lnum,'iniend.f90')
  ...
  character(len=spnamelen),dimension(nspectot*2) :: bufspec
  ! strings
...
NCERR(__LINE__)
    ! nspectot plus the conco
    ncstat=nf90_def_dim(end_ncid,'Species',         nspectot*2,  end_species_dimid)
NCERR(__LINE__)
