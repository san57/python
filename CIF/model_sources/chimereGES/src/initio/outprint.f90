subroutine outprint(iprint, print_title, nh, writeout, parout)
...
#define NCERR(lnum) if(ncstat/=NF90_NOERR) call nc_err(ncstat,lnum,'outprint.f90')
    ...
    real(kind = 8), allocatable, dimension(:, :, :) :: buf3d, buf3do
    ...
    !print*,'  Output',noutspec to files 'out''
    if (ad.eq.0) then
        ! TIMES
    ...
    if (print_title) then
        ...
        print 105, 'DATE        '                                   &
                ...
                !          ,output_species(2)%name(1:cl(output_species(2)%name)) &
                , ' Temp (2m)'                                         &
                , ' Surf Wind'                                         &
                , '  PBL Hght'                                         &
                , '  Rad Atte'                                         &
    ...
    104 format(i10, f8.1, f10.1, f10.1, f10.0, f10.2, f10.2, f10.2)
